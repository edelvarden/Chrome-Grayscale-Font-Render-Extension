...
const googleFontsList = [
  ...
  { fontFamily: 'Noto Sans TC', displayName: 'Noto Sans Traditional Chinese', fontStyle: 'sans-serif' },
  { fontFamily: 'Noto Sans SC', displayName: 'Noto Sans Simplified Chinese', fontStyle: 'sans-serif' },
